...
func TestAccessControlNewMemberFromProto(t *testing.T) {
	...
	signingMember := acInst.GetLocalSigningMember()
	require.NotNil(t, signingMember)
	signerRead, err := signingMember.GetSerializedMember()
...
func TestAccessControlCreatePrincipalAndGetValidEndorsementsAndVerifyPrincipal(t *testing.T) {
	...
	require.Nil(t, err)
	signerRead, err := acsMap[org1Name].commonNode.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org5Name].commonNode.GetSerializedMember()
	require.Nil(t, err)
	...
	sigRead, err = acsMap[org5Name].commonNode.Sign(acInst.GetHashAlg(), []byte(msg))
	require.Nil(t, err)
	signerRead, err = acsMap[org2Name].commonNode.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org1Name].admin.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org1Name].client.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org1Name].consensusNode.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org4Name].commonNode.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org4Name].admin.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerRead, err = acsMap[org3Name].admin.GetSerializedMember()
	require.Nil(t, err)
	endorsementRead = &common.EndorsementEntry{
		Signer:    signerRead,
		Signature: sigRead,
	...
	require.Nil(t, err)
	signerEurus, err := acsMap[org4Name].admin.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerAuster, err := acsMap[org3Name].admin.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerZephyrus, err := acsMap[org1Name].admin.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerBoreas, err := acsMap[org2Name].admin.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerThuellai, err := acsMap[org5Name].admin.GetSerializedMember()
	require.Nil(t, err)
	...
	require.Nil(t, err)
	signerZephyrusConsensus, err := acsMap[org1Name].consensusNode.GetSerializedMember()
	require.Nil(t, err)
