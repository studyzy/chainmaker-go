...
import (
	...
	"chainmaker.org/chainmaker-go/gasm/gasm-go/wasm/leb128"
)
...
func init() {
	...
	hostMethodGasMap["chainmaker.org/chainmaker-go/gasm/wasi.fd_write.func1"] = 1000
	hostMethodGasMap["chainmaker.org/chainmaker-go/gasm/examples.abc"] = 100000
}
