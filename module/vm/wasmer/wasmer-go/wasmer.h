...
uint64_t get_points_used(wasmer_instance_t *instance);
/// set the number of points used by an Instance.
void set_points_used(wasmer_instance_t *instance, uint64_t value);
/// set the number of points limit by an Instance.
void set_points_limit(wasmer_instance_t *instance, uint64_t value);
