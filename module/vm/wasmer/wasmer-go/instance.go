		...
		case cWasmFunction:
			...
			exports[exportedFunctionName] = func(arguments ...interface{}) (Value, error) {
				...
				if callResult != cWasmerOk {
					var lastError, err = GetLastError()
					if err == nil {
						return I32(0), NewExportedFunctionError(exportedFunctionName, "Failed to call the `%s` exported function. instance call error: "+lastError)
					}
...
func GetWasmerInstanceContext(instance *Instance) *InstanceContext {
	cWasmerInstanceContextT := cWasmerInstanceContextGet(instance.instance)
...
func (instance *Instance) GetGasUsed() uint64 {
	return uint64(cWasmerGetPointsUsed(instance.instance))
}

// SetGasUsed set gas
func (instance *Instance) SetGasUsed(value uint64) {
	cWasmerSetPointsUsed(instance.instance, cUint64T(value))
}

// SetGasLimit set gas limit
func (instance *Instance) SetGasLimit(value uint64) {
	cWasmerSetPointsLimit(instance.instance, cUint64T(value))
}
