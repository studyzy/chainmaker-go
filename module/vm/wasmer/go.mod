...
require (
	...
	chainmaker.org/chainmaker/pb-go v0.0.0-20210708095431-3ed1d2a0d58e // indirect
	chainmaker.org/chainmaker/protocol v0.0.0-20210708083310-ae8118431543 // indirect
)
