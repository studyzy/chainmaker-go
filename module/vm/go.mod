...
require (
	...
	//chainmaker.org/chainmaker-go/vm/native v0.0.0
	//chainmaker.org/chainmaker-go/vm/native/dposmgr v0.0.0
...
//chainmaker.org/chainmaker-go/vm/native => ./native
//chainmaker.org/chainmaker-go/vm/native/dposmgr => ./native/dposmgr
)
