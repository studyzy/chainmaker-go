...
func HandleCompatibility(chainConfig *config.ChainConfig) error {
	...
	for _, rp := range chainConfig.ResourcePolicies {
		...
		case consts.ChainConfigManager_NODE_ID_ADD.String():
			rp.ResourceName = consts.ChainConfigManager_NODE_ID_ADD.String()
		case consts.ChainConfigManager_NODE_ID_UPDATE.String():
			rp.ResourceName = consts.ChainConfigManager_NODE_ID_UPDATE.String()
		case consts.ChainConfigManager_NODE_ID_DELETE.String():
			rp.ResourceName = consts.ChainConfigManager_NODE_ID_DELETE.String()
		default:
			continue
		}
	}
