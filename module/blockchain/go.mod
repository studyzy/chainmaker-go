...
require (
	...
	chainmaker.org/chainmaker/common/v2 v2.0.1-0.20210915031628-981f8077963a
	...
	chainmaker.org/chainmaker/vm-native v0.0.0-20210915072159-1598396850f0 // indirect
