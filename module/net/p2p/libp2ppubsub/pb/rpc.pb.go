...
type Message struct {
	...
	PubsubUid            *string  `protobuf:"bytes,7,opt,name=pubsubUid" json:"pubsubUid,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Message) GetPubsubUid() string {
	if m != nil && m.PubsubUid != nil {
		return *m.PubsubUid
	}
	return ""
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PubsubUid != nil {
		i -= len(*m.PubsubUid)
		copy(dAtA[i:], *m.PubsubUid)
		i = encodeVarintRpc(dAtA, i, uint64(len(*m.PubsubUid)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Key != nil {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PubsubUid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
