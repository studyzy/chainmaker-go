...
type discover struct {
	...
	// options are the set of options to be used to complete struct construction in Init
...
// Init attaches the discovery pipeline to a libp2ppubsub instance, initializes discovery and starts event loop
