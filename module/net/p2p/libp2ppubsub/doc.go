// The libp2ppubsub package provides facilities for the Publish/Subscribe pattern of message
// propagation, also known as overlay multicast.
// The implementation provides topic-based libp2ppubsub, with pluggable routing algorithms.
//
...
//
// In addition, there is a generic constructor that creates a libp2ppubsub instance with
