...
func TestNetGmTls(t *testing.T) {
	var td = filepath.Join(os.TempDir(), "chainmaker_net_gmtls_test_key")
	os.Mkdir(td, 0666)
	...
	a.AddTrustRoot(chainId2, caBytes6666)
	a.AddTrustRoot(chainId2, caBytes7777)
	...
	b.AddTrustRoot(chainId2, caBytes6666)
