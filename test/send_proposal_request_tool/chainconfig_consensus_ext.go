...
func consensusExtAdd() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_CONSENSUS_EXT_ADD.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func consensusExtUpdate() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_CONSENSUS_EXT_UPDATE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func consensusExtDelete() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_CONSENSUS_EXT_DELETE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
