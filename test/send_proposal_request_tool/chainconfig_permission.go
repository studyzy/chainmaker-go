...
func permissionAdd() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_PERMISSION_ADD.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func permissionUpdate() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_PERMISSION_UPDATE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func permissionDelete() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_PERMISSION_DELETE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
