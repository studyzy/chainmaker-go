...
func nodeOrgAdd() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_NODE_ORG_ADD.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func nodeOrgUpdate() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_NODE_ORG_UPDATE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
...
func nodeOrgDelete() error {
	...
	resp, txId, err := configUpdateRequest(sk3, client, &InvokerMsg{txType: commonPb.TxType_INVOKE_CONTRACT, chainId: chainId,
		contractName: commonPb.SystemContract_CHAIN_CONFIG.String(), method: consts.ChainConfigManager_NODE_ORG_DELETE.String(), pairs: pairs, oldSeq: seq})
	if err != nil {
		return err
	}
