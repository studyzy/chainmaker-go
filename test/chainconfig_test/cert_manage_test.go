...
func TestCertFrozen(t *testing.T) {
	...
	pairs := []*commonPb.KeyValuePair{
		...
		//{
		//	Key:   "certs", // org5 admin sign cert
		//	Value: []byte("-----BEGIN CERTIFICATE-----\\nNK1L3gMxBJT1qyJgOCm3b+3DQ1wRnvs9Um1T\n-----END CERTIFICATE-----\n"),
		//},
		//{
		//	Key:   "certs", // ca
