...
func TestCertDelete(t *testing.T) {
	...
	pairs := []*commonPb.KeyValuePair{
		{
			Key:   "cert_hashes_1",
			Value: []byte("de536ef8c323ae708586f9486bc3fe8bbba6452ff940a6e69de00db5159e5b1e"),
		},
	}
	sk, member := native.GetUserSK(1)
...
func TestCertQuery(t *testing.T) {
	...
	pairs := []*commonPb.KeyValuePair{
		{
			Key:   "cert_hashes",
			Value: []byte("b297d4e74ba0a88f9d154d63e53f2bf57116e09b6b8d2a718c24e59175f74cbe"),
		},
	}
	sk, member := native.GetUserSK(1)
...
func TestCertUnfrozenWithCertHash(t *testing.T) {
	...
	pairs = append(pairs, &commonPb.KeyValuePair{
		Key:   "cert_hashes_3",
		Value: []byte("ae052a0deeffe50ba2b447ed43b77c505dd0cc8c8dc918ce3dbb51073d874729,09ff34fafd2b97c8e9c7e05704b075d90cb7fee93cd2e4234e71cee6df0a88e6"),
	})
