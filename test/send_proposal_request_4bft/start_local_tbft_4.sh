...
if [ -z ${pid} ]; then
  nohup ./chainmaker start -c ../config/wx-org1/chainmaker.yml local-tbft >panic1.log 2>&1 &
...
if [ -z ${pid2} ]; then
  nohup ./chainmaker start -c ../config/wx-org2/chainmaker.yml local-tbft >panic2.log 2>&1 &
...
if [ -z ${pid3} ]; then
  nohup ./chainmaker start -c ../config/wx-org3/chainmaker.yml local-tbft >panic3.log 2>&1 &
...
if [ -z ${pid4} ]; then
  nohup ./chainmaker start -c ../config/wx-org4/chainmaker.yml local-tbft >panic4.log 2>&1 &
