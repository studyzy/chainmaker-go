...
//	// 构造Payload
//	//pair := &pb.KeyValuePair{Key: "height", Value: strconv.FormatInt(1, 10)}
//	var pairs []*commonPb.KeyValuePair
//	//pairs = append(pairs, pair)
//
//	sk, member := GetUserSK(1)
//	resp, err := QueryRequest(sk, member, &client, &InvokeContractMsg{
//		TxType:       commonPb.TxType_QUERY_SYSTEM_CONTRACT,
//		ChainId:      "chain1",
//		TxId:         "",
//		ContractName: commonPb.ContractName_SYSTEM_CONTRACT_CHAIN_CONFIG.String(),
//		MethodName:   "GET_GOVERNMENT_CONTRACT",
//		Pairs:        pairs,
//	})
//	if err == nil {
//		result := &consensus.GovernmentContract{}
