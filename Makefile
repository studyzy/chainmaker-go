...
gomod:
	go get chainmaker.org/chainmaker/common@v2.0.0_dev
	go get chainmaker.org/chainmaker/pb-go@v2.0.0_dev
	go get chainmaker.org/chainmaker/protocol@v2.0.0_dev