...
const (
	...
	ContractName_SYSTEM_CONTRACT_REMOTE_ATTESTATION ContractName = 6
)
...
var ContractName_name = map[int32]string{
	...
	6: "SYSTEM_CONTRACT_REMOTE_ATTESTATION",
}
...
var ContractName_value = map[string]int32{
	...
	"SYSTEM_CONTRACT_REMOTE_ATTESTATION": 6,
}
...
var fileDescriptor_a1095c55e7168440 = []byte{
	...
	,
}
