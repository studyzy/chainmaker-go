...
func (m *MockProposalCache) GetProposedBlock(b *common.Block) (*common.Block, map[string]*common.TxRWSet) {
	m.ctrl.T.Helper()
...
func (m *MockProposalCache) SetProposedBlock(b *common.Block, rwSetMap map[string]*common.TxRWSet, selfProposed bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetProposedBlock", b, rwSetMap, selfProposed)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetProposedBlock indicates an expected call of SetProposedBlock
func (mr *MockProposalCacheMockRecorder) SetProposedBlock(b, rwSetMap, selfProposed interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetProposedBlock", reflect.TypeOf((*MockProposalCache)(nil).SetProposedBlock), b, rwSetMap, selfProposed)
}
