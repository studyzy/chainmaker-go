...
type ProposalCache interface {
	...
	GetProposedBlock(b *common.Block) (*common.Block, map[string]*common.TxRWSet, map[int64][]*common.ContractEvent)
	// Set porposed block in current consensus height, after it's generated or verified.
	SetProposedBlock(b *common.Block, rwSetMap map[string]*common.TxRWSet,contractEventMap map[int64][]*common.ContractEvent, selfProposed bool) error
