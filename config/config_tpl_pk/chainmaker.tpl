...
# 认证类型
auth_type: "public"   # [*] permissionedWithCert/permissionedWithKey/public. same as bc.yml auth_type
...
rpc:
  ...
  tls:
    ...
    #mode: oneway
    #mode:           twoway
    #priv_key_file:  ../config/{org_path}/node/{rpc_cert_path}/{rpc_cert_path}.key
